...
// Заполняет или обновляет график работы для указанного периода в соответствии с выходными днями.
//
// Параметры:
//   ДатаНачала - Дата - Начальная дата периода заполнения графика.
//   ДатаОкончания - Дата - Конечная дата периода заполнения графика.
//   ВыходныеДни - Строка - Строка с номерами дней недели, которые являются выходными (например, "6,7").
